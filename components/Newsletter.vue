  ...
  <div class="relative">
    <div class="bg-neutral-100 p-4 sm:p-10 text-center">
      <p class="typography-headline-4 sm:typography-headline-3 font-bold">
        Stay in the loop with our Cozy Community!
      </p>
      <p class="typography-text-sm sm:typography-text-base my-2 mb-4">
        Early access to upcoming sales and events. Receive gifts and special offers!</p>
      <form
        class="mb-4 flex flex-col sm:flex-row gap-4 max-w-[688px] mx-auto"
        @submit.prevent="subscribeNewsletter(inputValue)"
      >
        <SfInput v-model="inputValue" type="email" wrapper-class="grow !rounded-none" placeholder="Enter your email"
        />
        <SfButton   type="submit" 
          class="w-full sm:w-auto !rounded-none"
          variant="primary"> Subscribe to Newsletter </SfButton>
      </form>
      <div class="text-[12px] leading-[15px] text-neutral-600 max-w-[688px] mx-auto">
